...
IMAGES - KPAR - LPANE - NCORE - NPAR - NSIM - NOMEGAPAR - NTAUPAR - LUSENCCL 
...
(* you are also free to choose a compute unit consisting of an odd number of cores to accommodate an odd/prime number of k-points. This will require proper task-placement and falls outside the scope of the current guide; contact user support if you’d need assistance with this.)
...
-	In the pure MPI version of VASP, do you experience a speed-up if you only use 75% of the number of cores per node? Beware of task placement. 
...
using 1 task with 16 threads (there are 16 cores available per GPU in the ampere_gpu partition)
NSIM	Elapsed time (s) 
1	46801
2	29430
4	27222
